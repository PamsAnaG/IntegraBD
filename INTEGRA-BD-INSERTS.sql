...
INSERT INTO USUARIO (NOMBRE, APPATERNO, APMATERNO, USUARIO, PASSWORD, CORREO_ELECTRONICO, NUMERO_MOVIL, ID_ROL, ESTATUS, FECHA_REGISTRO) 
VALUES ('Leobardo', 'Jimenez', 'Sanchez', 'LJS', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 'pame23@gmail.com', '5527299581', 4, 'A', NOW())

INSERT INTO RECURSO (ID_USUARIO, ESTATUS, TIPO_RECURSO, COSTO_HORA, FECHA_REGISTRO) VALUES (2, 'A', 'Java Sr', 100, NOW());

INSERT INTO USUARIO (NOMBRE, APPATERNO, APMATERNO, USUARIO, PASSWORD, CORREO_ELECTRONICO, NUMERO_MOVIL, ID_ROL, ESTATUS, FECHA_REGISTRO) 
VALUES ('Jonathan', 'Lopez', 'Sanchez', 'JLS', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 'armando_garcia@demexis.com', '5527299581', 4, 'A', NOW())

INSERT INTO RECURSO (ID_USUARIO, ESTATUS, TIPO_RECURSO, COSTO_HORA, FECHA_REGISTRO) VALUES (3, 'A', 'ABAP', 100, NOW());

INSERT INTO USUARIO (NOMBRE, APPATERNO, APMATERNO, USUARIO, PASSWORD, CORREO_ELECTRONICO, NUMERO_MOVIL, ID_ROL, ESTATUS, FECHA_REGISTRO) 
VALUES ('Laura', 'Lopez', 'Sanchez', 'JLS', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 'armando_garcia@demexis.com', '5527299581', 4, 'A', NOW())

INSERT INTO RECURSO (ID_USUARIO, ESTATUS, TIPO_RECURSO, COSTO_HORA, FECHA_REGISTRO) VALUES (4, 'A', 'ABAP', 100, NOW());
